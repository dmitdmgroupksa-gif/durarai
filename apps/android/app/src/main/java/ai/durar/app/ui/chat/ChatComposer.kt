...
import ai.Durar.app.ui.mobileAccentBorderStrong
...
import ai.Durar.app.ui.mobileSurface
import ai.Durar.app.ui.mobileText
import ai.Durar.app.ui.mobileTextSecondary
import ai.Durar.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.Durar.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.Durar.app.ui.mobileFontFamily,
