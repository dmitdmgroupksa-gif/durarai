...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.Durar.ios", category: "LiveActivity")
    private var currentActivity: Activity<DurarActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = DurarActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<DurarActivityAttributes>.activities
    ...
    private func updateCurrent(state: DurarActivityAttributes.ContentState) {
    ...
    private func connectingState() -> DurarActivityAttributes.ContentState {
        DurarActivityAttributes.ContentState(
    ...
    private func idleState() -> DurarActivityAttributes.ContentState {
        DurarActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> DurarActivityAttributes.ContentState {
        DurarActivityAttributes.ContentState(
