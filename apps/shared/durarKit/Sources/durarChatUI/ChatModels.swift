...
public typealias DurarPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias DurarPlatformImage = UIImage
#endif

public struct DurarChatUsageCost: Codable, Hashable, Sendable {
...
public struct DurarChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: DurarChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(DurarChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct DurarChatMessageContent: Codable, Hashable, Sendable {
...
public struct DurarChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [DurarChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: DurarChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [DurarChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: DurarChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(DurarChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([DurarChatMessageContent].self, forKey: .content) {
...
public struct DurarChatHistoryPayload: Codable, Sendable {
...
public struct DurarSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct DurarSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [DurarSessionPreviewItem]
}

public struct DurarSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [DurarSessionPreviewEntry]

    public init(ts: Int, previews: [DurarSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct DurarChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct DurarChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct DurarAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct DurarChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct DurarGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct DurarPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: DurarPlatformImage?
...
public struct DurarChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
