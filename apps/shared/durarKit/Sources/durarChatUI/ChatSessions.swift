...
public struct DurarChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct DurarChatSessionsDefaults: Codable, Sendable {
...
public struct DurarChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct DurarChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: DurarChatSessionsDefaults?
    public let sessions: [DurarChatSessionEntry]
    ...
    public init(
        ...
        sessions: [DurarChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
