...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.Durar", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.Durar", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: DurarProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
