...
enum UIStrings {
    static let welcomeTitle = "Welcome to Durar"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "Durar.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: DurarChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g Durar@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: DurarChatViewModel(
