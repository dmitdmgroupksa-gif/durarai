...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.Durar", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".Durar/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.DurarCommand(
            subcommand: "gateway",
