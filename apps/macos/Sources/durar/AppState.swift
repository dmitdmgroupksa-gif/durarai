...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = DurarConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = DurarConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: DurarConfigFile.loadDict(),
        ...
        DurarConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/Durar"
        state.remoteCliPath = ""
        return state
    }
}
