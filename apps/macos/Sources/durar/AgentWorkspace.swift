...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.Durar", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return DurarConfigFile.defaultWorkspaceURL() }
