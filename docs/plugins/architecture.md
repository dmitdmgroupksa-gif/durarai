...
If Durar adds a new domain later, such as video generation, use the same
...
- If Durar adds a new capability such as video generation later, define the
...
- `Durar/plugin-sdk/channel-runtime` remains only as a compatibility shim.
