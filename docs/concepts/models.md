...
Durar selects models in this order:
...
- `agents.defaults.models` is the allowlist/catalog of models Durar can use (plus aliases).
...
- If you omit the provider, Durar treats the input as an alias or a model for the **default provider** (only works when there is no `/` in the model ID).
...
Durar models list
Durar models status
Durar models set <provider/model>
Durar models set-image <provider/model>

Durar models aliases list
Durar models aliases add <alias> <provider/model>
Durar models aliases remove <alias>

Durar models fallbacks list
Durar models fallbacks add <provider/model>
Durar models fallbacks remove <provider/model>
Durar models fallbacks clear

Durar models image-fallbacks list
Durar models image-fallbacks add <provider/model>
Durar models image-fallbacks remove <provider/model>
Durar models image-fallbacks clear
```

`Durar models` (no subcommand) is a shortcut for `models status`.
...
`Durar models scan` inspects OpenRouter’s **free model catalog** and can
...
agent directory (default `~/.Durar/agents/<agentId>/agent/models.json`). This file
...
This applies whenever Durar regenerates `models.json`, including command-driven paths like `Durar agent`.
