...
ClawHub is the public skills registry for Durar. Browse at
[https://clawhub.com](https://clawhub.com). Use native `Durar skills`
...
- `Durar skills install <slug>` is different: it downloads a ClawHub skill folder into the workspace and does not use the installer-metadata path above.
