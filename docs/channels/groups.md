...
Durar treats group chats consistently across surfaces: Discord, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo.

## Beginner intro (2 minutes)

Durar “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Durar can see that group and respond there.
...
Translation: allowlisted senders can trigger Durar by mentioning it.
...
By default, Durar prioritizes normal chat behavior and keeps context mostly as received. This means allowlists primarily decide who can trigger actions, not a universal redaction boundary for every quoted or historical snippet.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@Durar", "Durar", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
