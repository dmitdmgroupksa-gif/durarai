...
- [`.github/workflows/Durar-npm-release.yml`](https://github.com/dmitdmgroupksa-gif/durarai/blob/main/.github/workflows/Durar-npm-release.yml)
- [`scripts/Durar-npm-release-check.ts`](https://github.com/dmitdmgroupksa-gif/durarai/blob/main/scripts/Durar-npm-release-check.ts)
- [`scripts/package-mac-dist.sh`](https://github.com/dmitdmgroupksa-gif/durarai/blob/main/scripts/package-mac-dist.sh)
- [`scripts/make_appcast.sh`](https://github.com/dmitdmgroupksa-gif/durarai/blob/main/scripts/make_appcast.sh)
