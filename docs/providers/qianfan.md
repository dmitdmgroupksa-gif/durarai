---
summary: "Use Qianfan's unified API to access many models in Durar"
read_when:
...
3. Durar installed on your system
...
4. Copy the API key for use with Durar

## CLI setup

```bash
Durar onboard --auth-choice qianfan-api-key
```
...
- [Durar Configuration](/gateway/configuration)
