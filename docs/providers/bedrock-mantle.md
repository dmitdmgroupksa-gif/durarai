---
summary: "Use Amazon Bedrock Mantle (OpenAI-compatible) models with Durar"
read_when:
  - You want to use Bedrock Mantle hosted OSS models with Durar
...
Durar includes a bundled **Amazon Bedrock Mantle** provider that connects to
...
When `AWS_BEARER_TOKEN_BEDROCK` is set, Durar automatically discovers
