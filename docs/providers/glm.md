---
summary: "GLM model family overview + how to use it in Durar"
read_when:
  - You want GLM models in Durar
...
GLM is a **model family** (not a company) available through the Z.AI platform. In Durar, GLM
...
Durar currently seeds the bundled `zai` provider with these GLM refs:
