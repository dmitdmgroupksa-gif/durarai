---
summary: "Use NVIDIA's OpenAI-compatible API in Durar"
read_when:
  - You want to use NVIDIA models in Durar
...
Durar onboard --auth-choice skip
Durar models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
