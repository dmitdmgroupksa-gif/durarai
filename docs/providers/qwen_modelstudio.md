...
read_when:
  - You want to use Qwen (Alibaba Cloud Model Studio) with Durar
...
```bash
# China endpoint
Durar onboard --auth-choice modelstudio-standard-api-key-cn

# Global/Intl endpoint
Durar onboard --auth-choice modelstudio-standard-api-key
```
...
```bash
# China endpoint
Durar onboard --auth-choice modelstudio-api-key-cn

# Global/Intl endpoint
Durar onboard --auth-choice modelstudio-api-key
```
