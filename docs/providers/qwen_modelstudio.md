...
This page documents the endpoint mapping behind Durar's bundled `qwen`
...
shared `openai-completions` transport. Durar keys that off endpoint
...
Durar currently ships this bundled Qwen catalog:
