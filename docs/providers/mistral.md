---
summary: "Use Mistral models and Voxtral transcription with Durar"
read_when:
  - You want to use Mistral models in Durar
...
Durar supports Mistral for both text/image model routing (`mistral/...`) and
...
```bash
Durar onboard --auth-choice mistral-api-key
# or non-interactive
Durar onboard --mistral-api-key "$MISTRAL_API_KEY"
```
...
Durar currently ships this bundled Mistral catalog:
