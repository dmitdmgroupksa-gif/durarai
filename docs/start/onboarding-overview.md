---
summary: "Overview of Durar onboarding options and flows"
read_when:
...
Durar has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `Durar onboard`                     | Launch the app            |
...
CLI command docs: [`Durar onboard`](/cli/onboard)

## macOS app onboarding

Open the Durar app. The first-run wizard walks you through the same steps
