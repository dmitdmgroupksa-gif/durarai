...
Durar system heartbeat last
Durar logs --follow
Durar config get agents.defaults.heartbeat
Durar channels status --probe
```
...
```bash
Durar config get agents.defaults.heartbeat.activeHours
Durar config get agents.defaults.heartbeat.activeHours.timezone
Durar config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
Durar cron list
Durar logs --follow
```
