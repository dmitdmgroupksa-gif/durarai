...
Durar provides several automation mechanisms, each suited to different use cases. This page helps you choose the right one.
...
[TaskFlow](/automation/taskflow) is the flow orchestration substrate above background tasks. It manages durable multi-step flows with managed and mirrored sync modes, and exposes `Durar flows list|show|cancel` for inspection and recovery. See [TaskFlow](/automation/taskflow) for details.
