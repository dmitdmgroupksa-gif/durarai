---
summary: "CLI reference for `Durar browser` (profiles, tabs, actions, Chrome MCP, and CDP)"
read_when:
...
Manage Durar’s browser control server and run browser actions (tabs, snapshots, screenshots, navigation, clicks, typing).
