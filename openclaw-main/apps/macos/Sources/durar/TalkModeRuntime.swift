...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.Durar", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.Durar", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [DurarChatMessage] = messages.compactMap { item in
