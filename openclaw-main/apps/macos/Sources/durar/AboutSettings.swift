...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/dmitdmgroupksa-gif/durarai") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/dmitdmgroupksa-gif/durarai")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://Durar.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "DurarBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "DurarBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "DurarGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "DurarGitCommit") as? String) ??
            "unknown"
    }
