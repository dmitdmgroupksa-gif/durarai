...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.Durar", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        DurarPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        DurarPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
