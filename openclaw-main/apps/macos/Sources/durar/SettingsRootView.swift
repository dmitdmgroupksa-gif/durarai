...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .DurarSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? DurarPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? DurarPaths.stateDirURL.path
...
extension Notification.Name {
    static let DurarSelectSettingsTab = Notification.Name("DurarSelectSettingsTab")
}
