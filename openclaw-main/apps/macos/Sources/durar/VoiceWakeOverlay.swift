...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.Durar", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Durar windows, but below the system’s pop-up menus.
