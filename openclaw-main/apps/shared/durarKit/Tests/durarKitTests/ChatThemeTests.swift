...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = DurarChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = DurarChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
