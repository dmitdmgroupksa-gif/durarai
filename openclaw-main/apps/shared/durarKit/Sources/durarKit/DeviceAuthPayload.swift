...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: DurarProtocol.AnyCodable]?
    {
        ...
        return [
            "id": DurarProtocol.AnyCodable(identity.deviceId),
            "publicKey": DurarProtocol.AnyCodable(publicKey),
            "signature": DurarProtocol.AnyCodable(signature),
            "signedAt": DurarProtocol.AnyCodable(signedAtMs),
            "nonce": DurarProtocol.AnyCodable(nonce),
        ]
    }
}
