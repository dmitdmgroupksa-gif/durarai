...
public enum DurarCanvasA2UICommand: String, Codable, Sendable {
...
public struct DurarCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct DurarCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
