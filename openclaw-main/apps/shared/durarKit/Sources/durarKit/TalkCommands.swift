...
public enum DurarTalkCommand: String, Codable, Sendable {
...
public struct DurarTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct DurarTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
