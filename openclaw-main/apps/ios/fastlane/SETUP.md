...
ASC_KEYCHAIN_SERVICE=Durar-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.Durar.client
# or
...
- The beta flow regenerates `apps/ios/Durar.xcodeproj` from `apps/ios/project.yml` before archiving
