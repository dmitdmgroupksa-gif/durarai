...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.Durar.gateway"
    private static let nodeService = "ai.Durar.node"
    private static let talkService = "ai.Durar.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.Durar.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.Durar.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("Durar-gateway.log")
    }
