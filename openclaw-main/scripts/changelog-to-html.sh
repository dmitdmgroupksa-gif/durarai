...
if [[ -z "$version_content" ]]; then
  echo "<h2>Durar $VERSION</h2>"
  echo "<p>Latest Durar update.</p>"
  echo "<p><a href=\"https://github.com/dmitdmgroupksa-gif/durarai/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
