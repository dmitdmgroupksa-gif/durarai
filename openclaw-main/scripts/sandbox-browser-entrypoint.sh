...
export DISPLAY=:1
export HOME=/tmp/Durar-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${Durar_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${Durar_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${Durar_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${Durar_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${Durar_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${Durar_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${Durar_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${Durar_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${Durar_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${Durar_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${Durar_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
