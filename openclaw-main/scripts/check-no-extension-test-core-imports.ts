...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']Durar\/plugin-sdk["']/,
    hint: "Use Durar/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']Durar\/plugin-sdk\/test-utils["']/,
    hint: "Use Durar/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']Durar\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or Durar/plugin-sdk/testing for public surfaces.",
  },
  {
