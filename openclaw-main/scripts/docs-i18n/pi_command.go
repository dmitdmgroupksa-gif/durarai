...
const (
	envDocsPiExecutable     = "Durar_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "Durar_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "Durar_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "Durar", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
