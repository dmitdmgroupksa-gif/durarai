...
show_usage() {
    cat << EOF
clawlog - Durar Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Durar logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Durar logs flow through the macOS unified log (subsystem: ai.Durar).
