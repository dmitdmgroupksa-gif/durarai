...
- Durar_GATEWAY_VERSION = exact package.json version
- Durar_MARKETING_VERSION = short iOS/App Store version
- Durar_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
Durar_GATEWAY_VERSION = ${PACKAGE_VERSION}
Durar_MARKETING_VERSION = ${MARKETING_VERSION}
Durar_BUILD_VERSION = ${BUILD_NUMBER}
EOF
