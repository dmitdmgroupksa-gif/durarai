...
function pluginSource(dirName, artifactBasename = "api.js") {
  return `@Durar/${dirName}/${artifactBasename}`;
}
...
export const GENERATED_PLUGIN_SDK_FACADES = [
  ...
  },
  {
    ...
    directExports: {
      ...
      DEFAULT_Durar_BROWSER_COLOR: "./browser-config.js",
      DEFAULT_Durar_BROWSER_PROFILE_NAME: "./browser-config.js",
...
function normalizeFacadeSourceParts(sourcePath) {
  const packageSourceMatch = /^@Durar\/([^/]+)\/([^/]+)$/u.exec(sourcePath);
...
function collectRuntimeApiPreExports(repoRoot, runtimeApiPath) {
  ...
  for (const statement of sourceFile.statements) {
    ...
    if (moduleSpecifier === "Durar/plugin-sdk/line-runtime") {
      break;
    }
