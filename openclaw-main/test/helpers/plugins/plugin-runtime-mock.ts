import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "Durar/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "Durar/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "Durar/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  ...
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/Durar"),
    },
    tasks: {
      flow: taskFlow,
    },
