...
import { isSecretRef, type DurarConfig } from "Durar/plugin-sdk/core";
import { safeParseJsonWithSchema, safeParseWithSchema } from "Durar/plugin-sdk/extension-shared";
import { z } from "zod";
...
export function listEnabledGoogleChatAccounts(cfg: DurarConfig): ResolvedGoogleChatAccount[] {
