...
export function resolveSearxngCategories(config?: DurarConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: DurarConfig): string | undefined {
