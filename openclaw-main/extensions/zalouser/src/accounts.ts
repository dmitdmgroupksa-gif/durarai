...
function mergeZalouserAccountConfig(cfg: DurarConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: DurarConfig; accountId?: string | null }) {
