...
vi.mock("Durar/plugin-sdk/config-runtime", async () => {
  ...
  return {
    ...actual,
    loadConfig: () => config,
    resolveStorePath: vi.fn(() => "/tmp/Durar-sessions.json"),
...
vi.mock("Durar/plugin-sdk/conversation-runtime", async () => {
  const actual = await vi.importActual<typeof import("Durar/plugin-sdk/conversation-runtime")>(
    "Durar/plugin-sdk/conversation-runtime",
  );
  return {
    ...actual,
...
vi.mock("Durar/plugin-sdk/security-runtime", async () => {
  const actual = await vi.importActual<typeof import("Durar/plugin-sdk/security-runtime")>(
    "Durar/plugin-sdk/security-runtime",
  );
  return {
    ...actual,
...
vi.mock("Durar/plugin-sdk/channel-runtime", async () => {
  const actual = await vi.importActual<typeof import("Durar/plugin-sdk/channel-runtime")>(
    "Durar/plugin-sdk/channel-runtime",
  );
  return {
    ...actual,
...
export function installSignalToolResultTestHooks() {
  beforeEach(async () => {
    const [{ resetInboundDedupe }, { resetSystemEventsForTest }] = await Promise.all([
      import("Durar/plugin-sdk/reply-runtime"),
      import("Durar/plugin-sdk/channel-runtime"),
    ]);
    resetInboundDedupe();
    config = {
