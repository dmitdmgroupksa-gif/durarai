...
import type { ResolvedAgentRoute } from "Durar/plugin-sdk/routing";
...
type ResolveConfiguredBindingRouteFn =
  typeof import("Durar/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("Durar/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
vi.mock("Durar/plugin-sdk/command-auth", async (importOriginal) => {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/Durar-sessions.json");
