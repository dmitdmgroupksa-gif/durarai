...
import { isTruthyEnvValue, isWSL2Sync } from "Durar/plugin-sdk/runtime-env";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "Durar_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "Durar_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "Durar_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable Durar_TELEGRAM_DNS_RESULT_ORDER
