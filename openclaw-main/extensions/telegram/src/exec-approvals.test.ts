...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<DurarConfig["channels"]>["telegram"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<DurarConfig["channels"]>["telegram"]>>,
): DurarConfig {
  return {
    channels: {
      telegram: {
