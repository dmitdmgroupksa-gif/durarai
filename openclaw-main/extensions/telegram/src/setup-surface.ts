...
function shouldShowTelegramDmAccessWarning(cfg: DurarConfig, accountId: string): boolean {
...
function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`Durar config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`Durar config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
