...
import { resolveApiKeyForProvider } from "Durar/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "Durar/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
...
import { loadJsonFile, saveJsonFile } from "Durar/plugin-sdk/json-store";
import { AUTO_IMAGE_KEY_PROVIDERS, DEFAULT_IMAGE_MODELS } from "Durar/plugin-sdk/media-runtime";
import { resolveAutoImageModel } from "Durar/plugin-sdk/media-runtime";
import { describeImageFileWithModel } from "Durar/plugin-sdk/media-understanding-runtime";
import { logVerbose } from "Durar/plugin-sdk/runtime-env";
import { STATE_DIR } from "Durar/plugin-sdk/state-paths";
