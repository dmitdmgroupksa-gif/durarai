import { resolveAccountWithDefaultFallback } from "Durar/plugin-sdk/account-core";
import type { DurarConfig } from "Durar/plugin-sdk/config-runtime";
import { coerceSecretRef } from "Durar/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "Durar/plugin-sdk/core";
import { resolveDefaultSecretProviderAlias } from "Durar/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "Durar/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "Durar/plugin-sdk/secret-input";
import type { TelegramAccountConfig } from "Durar/plugin-sdk/telegram-core";
import {
...
function inspectTokenValue(params: { cfg: DurarConfig; value: unknown }): {
  token: string;
