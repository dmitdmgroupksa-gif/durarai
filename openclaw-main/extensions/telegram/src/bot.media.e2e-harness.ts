...
import type { GetReplyOptions, MsgContext } from "Durar/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("Durar/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as DurarConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("Durar/plugin-sdk/media-runtime")>,
) {
...
vi.mock("Durar/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("Durar/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("Durar/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
