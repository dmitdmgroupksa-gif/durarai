...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "Durar/plugin-sdk/setup";
import { formatCliCommand, formatDocsLink } from "Durar/plugin-sdk/setup-tools";
import type { TelegramNetworkConfig } from "Durar/plugin-sdk/telegram-core";
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://Durar.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("Durar logs --follow")}\` (safest)`,
