...
import {
  ...
  loadModelCatalog,
  modelSupportsVision,
} from "Durar/plugin-sdk/agent-runtime";
...
import { clearHistoryEntriesIfEnabled } from "Durar/plugin-sdk/reply-history";
import { resolveSendableOutboundReplyParts } from "Durar/plugin-sdk/reply-payload";
import { resolveChunkMode } from "Durar/plugin-sdk/reply-runtime";
import type { ReplyPayload } from "Durar/plugin-sdk/reply-runtime";
import { resolveAutoTopicLabelConfig, generateTopicLabel } from "Durar/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: DurarConfig, agentId: string) {
  try {
