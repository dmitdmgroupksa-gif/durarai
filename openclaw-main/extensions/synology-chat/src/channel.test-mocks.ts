...
vi.mock("Durar/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("Durar/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("Durar/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("Durar/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("Durar/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("Durar/plugin-sdk/webhook-ingress");
  return {
    ...actual,
