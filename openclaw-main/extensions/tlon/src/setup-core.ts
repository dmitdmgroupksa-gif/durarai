...
export async function resolveTlonSetupConfigured(cfg: DurarConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: DurarConfig): Promise<string[]> {
