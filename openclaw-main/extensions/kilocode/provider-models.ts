import type { KilocodeModelCatalogEntry } from "Durar/plugin-sdk/provider-model-shared";
import type { ModelDefinitionConfig } from "Durar/plugin-sdk/provider-model-shared";
