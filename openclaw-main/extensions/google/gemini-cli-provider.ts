...
import { buildOauthProviderAuthResult } from "Durar/plugin-sdk/provider-auth-result";
import { fetchGeminiUsage } from "Durar/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: DurarPluginApi) {
