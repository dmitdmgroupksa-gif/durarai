...
vi.mock("Durar/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("Durar/plugin-sdk/provider-auth")>(
    "Durar/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
