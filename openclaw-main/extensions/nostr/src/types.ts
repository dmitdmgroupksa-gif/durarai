...
import { normalizeSecretInputString, type SecretInput } from "Durar/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: DurarConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: DurarConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: DurarConfig): string {
