...
type XaiPluginConfig = NonNullable<
  NonNullable<DurarConfig["plugins"]>["entries"]
>["xai"] extends {
  config?: infer Config;
}
  ? Config
...
function readPluginCodeExecutionConfig(cfg?: DurarConfig): CodeExecutionConfig | undefined {
    ...
    execute: async (_toolCallId: string, args: Record<string, unknown>) => {
      ...
      if (!apiKey) {
        return jsonResult({
          ...
          docs: "https://docs.Durar.ai/tools/code-execution",
        });
      }
