...
import type { ChannelSetupInput } from "Durar/plugin-sdk/setup";
...
/**
 * Setup-only QQBot plugin — lightweight subset used during `Durar onboard`
 * and `Durar configure` without pulling the full runtime dependencies.
 */
