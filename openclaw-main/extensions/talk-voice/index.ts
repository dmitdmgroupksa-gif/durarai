import { resolveActiveTalkProviderConfig } from "Durar/plugin-sdk/config-runtime";
import type { SpeechVoiceOption } from "Durar/plugin-sdk/speech";
import { definePluginEntry, type DurarPluginApi } from "./api.js";
