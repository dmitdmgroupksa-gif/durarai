import { definePluginEntry, type ProviderAuthContext } from "Durar/plugin-sdk/plugin-entry";
import {
  coerceSecretRef,
  ensureAuthProfileStore,
  listProfilesForProvider,
} from "Durar/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "Durar/plugin-sdk/provider-auth-login";
