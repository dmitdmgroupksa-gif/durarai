...
export function listWhatsAppAuthDirs(cfg: DurarConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: DurarConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: DurarConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: DurarConfig): ResolvedWhatsAppAccount[] {
