...
function mergeZaloAccountConfig(cfg: DurarConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: DurarConfig): ResolvedZaloAccount[] {
