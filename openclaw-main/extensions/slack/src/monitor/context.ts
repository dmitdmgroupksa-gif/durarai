...
import { resolveSessionKey, type SessionScope } from "Durar/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "Durar/plugin-sdk/config-runtime";
import { createDedupeCache } from "Durar/plugin-sdk/core";
import type { HistoryEntry } from "Durar/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("Durar/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
