...
import { type ChatCommandDefinition, type CommandArgs } from "Durar/plugin-sdk/command-auth";
import {
...
import { chunkItems } from "Durar/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "Durar_cmdarg";
