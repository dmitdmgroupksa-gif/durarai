...
function enableSlackAccount(cfg: DurarConfig, accountId: string): DurarConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: DurarConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: DurarConfig; accountId: string }) =>
