...
import { buildPluginConfigSchema, type DurarPluginConfigSchema } from "Durar/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): DurarPluginConfigSchema {
