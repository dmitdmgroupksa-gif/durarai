...
export function resolveTavilySearchConfig(cfg?: DurarConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: DurarConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: DurarConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
