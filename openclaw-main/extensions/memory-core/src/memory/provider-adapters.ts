...
import { resolveUserPath } from "Durar/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "Durar/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall Durar (this should install node-llama-cpp): npm i -g Durar@latest"
      : null,
