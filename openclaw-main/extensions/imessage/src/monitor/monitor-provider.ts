...
import { createChannelPairingChallengeIssuer } from "Durar/plugin-sdk/channel-pairing";
import { createChannelReplyPipeline } from "Durar/plugin-sdk/channel-reply-pipeline";
import { waitForTransportReady } from "Durar/plugin-sdk/channel-runtime";
import { loadConfig } from "Durar/plugin-sdk/config-runtime";
import {
...
import { normalizeScpRemoteHost } from "Durar/plugin-sdk/host-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "Durar/plugin-sdk/media-runtime";
import { kindFromMime } from "Durar/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "Durar/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "Durar/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "Durar/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "Durar/plugin-sdk/reply-runtime";
import { danger, logVerbose, shouldLogVerbose, warn } from "Durar/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "Durar/plugin-sdk/security-runtime";
 ...
 *   exec ssh -T Durar@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., Durar@192.168.64.3)
