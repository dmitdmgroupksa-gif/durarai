...
export const imessageDmPolicy = createTopLevelChannelDmPolicy({
  ...
  getCurrent: (cfg: DurarConfig) => cfg.channels?.imessage?.dmPolicy ?? "pairing",
  promptAllowFrom: promptIMessageAllowFrom,
});

function resolveIMessageCliPath(params: { cfg: DurarConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure Durar has Full Disk Access to Messages DB.",
