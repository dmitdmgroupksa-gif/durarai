...
function mergeIMessageAccountConfig(cfg: DurarConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: DurarConfig): ResolvedIMessageAccount[] {
