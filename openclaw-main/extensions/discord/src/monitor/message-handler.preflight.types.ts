...
import type { resolveAgentRoute } from "Durar/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("Durar/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("Durar/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("Durar/plugin-sdk/config-runtime").DurarConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
