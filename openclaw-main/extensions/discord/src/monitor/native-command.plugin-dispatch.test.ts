...
import type { NativeCommandSpec } from "Durar/plugin-sdk/command-auth";
import type { DurarConfig } from "Durar/plugin-sdk/config-runtime";
import { clearPluginCommands, registerPluginCommand } from "Durar/plugin-sdk/plugin-runtime";
import { setDefaultChannelPluginRegistryForTests } from "Durar/plugin-sdk/testing";
...
vi.mock("Durar/plugin-sdk/plugin-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("Durar/plugin-sdk/plugin-runtime")>();
  return {
    ...actual,
...
vi.mock("Durar/plugin-sdk/reply-runtime", async (importOriginal) => {
...
function createConfig(): DurarConfig {
  return {
    channels: {
      discord: {
...
async function createNativeCommand(cfg: DurarConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: DurarConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
async function createStatusCommand(cfg: DurarConfig) {
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(async () => {
    ...
    const actualPluginRuntime = await vi.importActual<
      typeof import("Durar/plugin-sdk/plugin-runtime")
    >("Durar/plugin-sdk/plugin-runtime");
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("Durar/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("Durar/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("Durar/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
    );
