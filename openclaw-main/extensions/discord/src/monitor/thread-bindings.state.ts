...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "Durar/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("Durar.discordThreadBindingsState");
