...
import { resolveCommandAuthorizedFromAuthorizers } from "Durar/plugin-sdk/command-auth-native";
...
import * as conversationRuntime from "Durar/plugin-sdk/conversation-runtime";
import { resolveAgentRoute } from "Durar/plugin-sdk/routing";
import { logVerbose } from "Durar/plugin-sdk/runtime-env";
import * as securityRuntime from "Durar/plugin-sdk/security-runtime";
import { logError } from "Durar/plugin-sdk/text-runtime";
import {
...
export type AgentComponentContext = {
  ...
  runtime?: import("Durar/plugin-sdk/runtime-env").RuntimeEnv;
  token?: string;
