...
import { buildPluginBindingApprovalCustomId } from "Durar/plugin-sdk/conversation-runtime";
...
async function createChannelRuntimeMock(
  importOriginal: () => Promise<typeof import("Durar/plugin-sdk/channel-runtime")>,
) {
...
vi.mock("Durar/plugin-sdk/channel-runtime", createChannelRuntimeMock);
vi.mock("Durar/plugin-sdk/channel-runtime.js", createChannelRuntimeMock);
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/Durar-sessions-test.json");
