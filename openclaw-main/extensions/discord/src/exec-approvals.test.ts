...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<DurarConfig["channels"]>["discord"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<DurarConfig["channels"]>["discord"]>>,
): DurarConfig {
  return {
    channels: {
      discord: {
