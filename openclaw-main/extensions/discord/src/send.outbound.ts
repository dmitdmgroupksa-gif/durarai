...
import { loadConfig, type DurarConfig } from "Durar/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "Durar/plugin-sdk/config-runtime";
import { maxBytesForKind } from "Durar/plugin-sdk/media-runtime";
import { extensionForMime } from "Durar/plugin-sdk/media-runtime";
import { unlinkIfExists } from "Durar/plugin-sdk/media-runtime";
import type { PollInput } from "Durar/plugin-sdk/media-runtime";
import { resolveChunkMode } from "Durar/plugin-sdk/reply-runtime";
import type { RetryConfig } from "Durar/plugin-sdk/retry-runtime";
...
import { loadWebMediaRaw } from "Durar/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredDurarTmpDir();
