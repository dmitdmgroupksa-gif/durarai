import type { BrowserConfig, BrowserProfileConfig, DurarConfig } from "../config/config.js";
...
/**
 * Ensure the default "Durar" profile exists in the profiles map.
