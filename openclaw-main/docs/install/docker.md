...
<Steps>
  <Step title="Build the image">
    ...
    ```bash
    export Durar_IMAGE="ghcr.io/dmitdmgroupksa-gif/durarai:latest"
    ./scripts/docker/setup.sh
    ```

    Pre-built images are published at the
    [GitHub Container Registry](https://github.com/dmitdmgroupksa-gif/durarai/pkgs/container/Durar).
...
<AccordionGroup>
  <Accordion title="Image missing or sandbox container not starting">
    ...
    [`scripts/sandbox-setup.sh`](https://github.com/dmitdmgroupksa-gif/durarai/blob/main/scripts/sandbox-setup.sh)
