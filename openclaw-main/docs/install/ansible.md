...
Deploy Durar to production servers with **[Durar-ansible](https://github.com/dmitdmgroupksa-gif/durarai-ansible)** -- an automated installer with security-first architecture.

<Info>
The [Durar-ansible](https://github.com/dmitdmgroupksa-gif/durarai-ansible) repo is the source of truth for Ansible deployment. This page is a quick overview.
</Info>
...
- [Security Architecture](https://github.com/dmitdmgroupksa-gif/durarai-ansible/blob/main/docs/security.md)
- [Technical Details](https://github.com/dmitdmgroupksa-gif/durarai-ansible/blob/main/docs/architecture.md)
- [Troubleshooting Guide](https://github.com/dmitdmgroupksa-gif/durarai-ansible/blob/main/docs/troubleshooting.md)

## Related

- [Durar-ansible](https://github.com/dmitdmgroupksa-gif/durarai-ansible) -- full deployment guide
