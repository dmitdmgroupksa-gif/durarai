...
summary: 使用 Ansible、Tailscale VPN 和防火墙隔离进行自动化、加固的 Durar 安装
title: Ansible
x-i18n:
...
将 Durar 部署到生产服务器的推荐方式是通过 **[Durar-ansible](https://github.com/dmitdmgroupksa-gif/durarai-ansible)** — 一个安全优先架构的自动化安装程序。
...
```bash
curl -fsSL https://raw.githubusercontent.com/Durar/Durar-ansible/main/install.sh | bash
```

> **📦 完整指南：[github.com/dmitdmgroupksa-gif/durarai-ansible](https://github.com/dmitdmgroupksa-gif/durarai-ansible)**
>
> Durar-ansible 仓库是 Ansible 部署的权威来源。本页是快速概述。
...
# 2. 克隆仓库
git clone https://github.com/dmitdmgroupksa-gif/durarai-ansible.git
cd Durar-ansible
...
# 或直接运行（然后手动执行 /tmp/Durar-setup.sh）
# ansible-playbook playbook.yml --ask-become-pass
```

## 更新 Durar

Ansible 安装程序设置 Durar 为手动更新。标准更新流程参见[更新](/install/updating)。
...
- [安全架构](https://github.com/dmitdmgroupksa-gif/durarai-ansible/blob/main/docs/security.md)
- [技术详情](https://github.com/dmitdmgroupksa-gif/durarai-ansible/blob/main/docs/architecture.md)
- [故障排除指南](https://github.com/dmitdmgroupksa-gif/durarai-ansible/blob/main/docs/troubleshooting.md)

## 相关内容

- [Durar-ansible](https://github.com/dmitdmgroupksa-gif/durarai-ansible) — 完整部署指南
