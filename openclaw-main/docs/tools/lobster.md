...
Lobster is one authoring layer above detached background work. For flow orchestration above individual tasks, see [TaskFlow](/automation/taskflow) (`Durar flows`). For the task activity ledger, see [`Durar tasks`](/automation/tasks).
