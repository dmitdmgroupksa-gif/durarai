...
Durar treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.Durar/settings/voicewake.json`

Shape:

```json
{ "triggers": ["Durar", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
