---
summary: "First-run setup flow for Durar (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Durar">
...
<Step title="CLI">
  ...
  The app can install the global `Durar` CLI via npm/pnpm so terminal
