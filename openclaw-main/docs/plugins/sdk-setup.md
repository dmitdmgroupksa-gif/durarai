...
```json Durar-clawhub-package.json
{
...
Durar tries ClawHub first and falls back to npm automatically. You can also
force a specific source:

```bash
Durar plugins install clawhub:@myorg/Durar-my-plugin   # ClawHub only
Durar plugins install npm:@myorg/Durar-my-plugin       # npm only
```
