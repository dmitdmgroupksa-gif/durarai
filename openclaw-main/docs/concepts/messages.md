...
This page ties together how Durar handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Durar keeps a
...
Durar separates the **prompt body** from the **command body**:
...
Durar can expose or hide model reasoning:
