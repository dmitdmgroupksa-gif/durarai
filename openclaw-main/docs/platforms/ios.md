...
The Gateway advertises `_Durar-gw._tcp` on `local.`. The iOS app lists these automatically.

### Tailnet (cross-network)

If mDNS is blocked, use a unicast DNS-SD zone (choose a domain; example: `Durar.internal.`) and Tailscale split DNS.
