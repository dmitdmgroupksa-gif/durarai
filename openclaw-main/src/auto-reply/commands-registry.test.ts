...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@Durar", { botUsername: "Durar" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@Durar args", {
        botUsername: "Durar",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "Durar" })).toBe(
      "/help@otherbot",
    );
  });
