...
function resolveMentionPatterns(cfg: DurarConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: DurarConfig | undefined, agentId?: string): RegExp[] {
