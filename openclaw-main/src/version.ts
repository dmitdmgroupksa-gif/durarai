...
declare const __Durar_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "Durar";
...
function resolveVersionFromRuntimeSources(params: {
  ...
  const preferredCandidates =
    params.preference === "env-first"
      ? [params.env["Durar_VERSION"], params.runtimeVersion]
      : [params.runtimeVersion, params.env["Durar_VERSION"]];
  return (
    firstNonEmpty(
      ...preferredCandidates,
      params.env["Durar_SERVICE_VERSION"],
...
// Single source of truth for the current Durar version.
// - Embedded/bundled builds: injected define or env var.
// - Dev/npm builds: package.json.
export const VERSION = resolveBinaryVersion({
  moduleUrl: import.meta.url,
  injectedVersion: typeof __Durar_VERSION__ === "string" ? __Durar_VERSION__ : undefined,
  bundledVersion: process.env.Durar_BUNDLED_VERSION,
});
