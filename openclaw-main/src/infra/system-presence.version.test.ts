  ...
  return withEnvAsync(
    {
      ...
      Durar_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when Durar_VERSION is not set", async () => {
  ...
  it("prefers Durar_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over Durar_SERVICE_VERSION when Durar_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        Durar_VERSION: " ",
        Durar_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when Durar_VERSION and Durar_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        Durar_VERSION: " ",
        Durar_SERVICE_VERSION: "\t",
