...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "NO_PROXY",
  "Durar_AGENT_DIR",
  "Durar_BUNDLED_HOOKS_DIR",
  "Durar_BUNDLED_PLUGINS_DIR",
  "Durar_BUNDLED_SKILLS_DIR",
  "Durar_CONFIG_PATH",
  "Durar_GATEWAY_PASSWORD",
  "Durar_GATEWAY_SECRET",
  "Durar_GATEWAY_TOKEN",
  "Durar_HOME",
  "Durar_LIVE_ANTHROPIC_KEY",
  "Durar_LIVE_ANTHROPIC_KEYS",
  "Durar_LIVE_GEMINI_KEY",
  "Durar_LIVE_OPENAI_KEY",
  "Durar_OAUTH_DIR",
  "Durar_PINNED_PYTHON",
  "Durar_PINNED_WRITE_PYTHON",
  "Durar_PROFILE",
  "Durar_STATE_DIR",
  "OPENAI_API_KEY",
  "OPENAI_API_KEYS",
...
function shouldBlockRuntimeDotEnvKey(key: string): boolean {
  // The global ~/.Durar/.env (or Durar_STATE_DIR/.env) is a trusted
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.Durar/.env (or Durar_STATE_DIR/.env),
