...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "Durar-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "Durar-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "Durar-flexible-media-roots-state"),
      cfg: {},
      shouldContainPictures: false,
    },
    {
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "Durar-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "Durar-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps agent-scoped defaults even when mediaSources include file URLs and top-level paths", () => {
    const stateDir = path.join("/tmp", "Durar-file-url-media-roots-state");
    const picturesDir =
