...
function resolveConfigBackedProviderAuth(params: { provider: string; config?: DurarConfig }):
  | {
      apiKey: string;
      discoveryApiKey?: string;
      mode: "api_key";
...
function resolveXaiConfigFallbackAuth(params: { provider: string; config?: DurarConfig }):
  | {
      apiKey: string;
      source: string;
      mode: "api-key";
