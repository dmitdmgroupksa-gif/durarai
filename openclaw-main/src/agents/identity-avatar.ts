...
function resolveAvatarSource(cfg: DurarConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: DurarConfig, agentId: string): AgentAvatarResolution {
