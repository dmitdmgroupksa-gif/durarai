...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/Durar-sandbox",
    agentWorkspaceDir: "/tmp/Durar-workspace",
    workspaceAccess: "none",
    runtimeId: "Durar-sbx-test",
    runtimeLabel: "Durar-sbx-test",
    containerName: "Durar-sbx-test",
    ...
    browser: {
      ...
      containerName: "Durar-sbx-browser-test",
    },
