...
const CLEANUP_STATE_KEY = Symbol.for("Durar.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("Durar.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("Durar.sessionWriteLockWatchdogState");
