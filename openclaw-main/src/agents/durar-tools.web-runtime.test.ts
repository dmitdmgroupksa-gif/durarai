...
function requireWebSearchTool(config: DurarConfig, runtimeWebSearch?: RuntimeWebSearchMetadata) {
...
function requireWebFetchTool(config: DurarConfig, runtimeWebFetch?: RuntimeWebFetchMetadata) {
...
async function prepareAndActivate(params: { config: DurarConfig; env?: NodeJS.ProcessEnv }) {
...
describe("Durar tools runtime web metadata wiring", () => {
