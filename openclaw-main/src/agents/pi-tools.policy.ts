...
export function resolveSubagentToolPolicy(cfg?: DurarConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: DurarConfig["tools"]): string[] | undefined {
