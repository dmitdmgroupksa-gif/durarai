...
export const DEFAULT_SANDBOX_IMAGE = "Durar-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "Durar-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "Durar-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "Durar-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "Durar-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "Durar-sandbox-browser";
