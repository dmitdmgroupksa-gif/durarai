...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof DurarConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: DurarConfig; env: NodeJS.ProcessEnv }): {
  cfg: DurarConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
