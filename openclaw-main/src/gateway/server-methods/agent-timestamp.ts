 ...
 *
 * @see https://github.com/dmitdmgroupksa-gif/durarai/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an DurarConfig.
 */
export function timestampOptsFromConfig(cfg: DurarConfig): TimestampInjectionOptions {
  return {
