...
export function hasAmbiguousGatewayAuthModeConfig(cfg: DurarConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: DurarConfig): void {
