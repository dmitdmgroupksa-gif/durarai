...
export function collectConfiguredModelPricingRefs(config: DurarConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: DurarConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
