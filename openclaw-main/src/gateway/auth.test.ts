...
describe("gateway auth", () => {
  ...
  it("resolves token/password from Durar gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          Durar_GATEWAY_TOKEN: "env-token",
          Durar_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides Durar_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        Durar_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
