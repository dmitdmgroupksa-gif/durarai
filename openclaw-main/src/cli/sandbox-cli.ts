...
const SANDBOX_EXAMPLES = {
  main: [
    ["Durar sandbox list", "List all sandbox containers."],
    ["Durar sandbox list --browser", "List only browser containers."],
    ["Durar sandbox recreate --all", "Recreate all containers."],
    ["Durar sandbox recreate --session main", "Recreate a specific session."],
    ["Durar sandbox recreate --agent mybot", "Recreate agent containers."],
    ["Durar sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["Durar sandbox list", "List all sandbox containers."],
    ["Durar sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["Durar sandbox recreate --all", "Recreate all containers."],
    ["Durar sandbox recreate --session main", "Recreate a specific session."],
    ["Durar sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["Durar sandbox recreate --browser --all", "Recreate only browser containers."],
    ["Durar sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["Durar sandbox explain", "Show effective sandbox config."],
    ["Durar sandbox explain --session agent:main:main", "Explain a specific session."],
    ["Durar sandbox explain --agent work", "Explain an agent sandbox."],
    ["Durar sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.Durar.ai/cli/sandbox")}\n`,
    )
    .action(() => {
