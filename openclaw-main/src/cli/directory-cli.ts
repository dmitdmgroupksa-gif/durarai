    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["Durar directory self --channel slack", "Show the connected account identity."],
          [
            'Durar directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["Durar directory groups list --channel discord", "List available groups/channels."],
          [
            "Durar directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.Durar.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
