...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("Durar.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("Durar.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: DurarConfig): Promise<ContextEngine> {
