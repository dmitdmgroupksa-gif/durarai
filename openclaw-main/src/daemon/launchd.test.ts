...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.Durar.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", Durar_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.Durar.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when Durar_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.Durar.gateway.plist",
    },
    {
      name: "uses profile-specific label when Durar_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", Durar_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.Durar.jbphoenix.plist",
    },
    {
      name: "prefers Durar_LAUNCHD_LABEL over Durar_PROFILE",
      env: {
        HOME: "/Users/test",
        Durar_PROFILE: "jbphoenix",
        Durar_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from Durar_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        Durar_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty Durar_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        Durar_PROFILE: "myprofile",
        Durar_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.Durar.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
