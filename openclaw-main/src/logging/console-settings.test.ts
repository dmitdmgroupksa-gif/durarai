...
let originalDurarTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalDurarTestConsole = process.env.Durar_TEST_CONSOLE;
  process.env.Durar_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalDurarTestConsole === undefined) {
    delete process.env.Durar_TEST_CONSOLE;
  } else {
    process.env.Durar_TEST_CONSOLE = originalDurarTestConsole;
  }
