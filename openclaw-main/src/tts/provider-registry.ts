...
function resolveSpeechProviderPluginEntries(cfg?: DurarConfig): SpeechProviderPlugin[] {
...
function buildProviderMaps(cfg?: DurarConfig): {
...
export function listSpeechProviders(cfg?: DurarConfig): SpeechProviderPlugin[] {
