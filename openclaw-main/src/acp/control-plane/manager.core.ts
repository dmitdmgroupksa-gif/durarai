...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: DurarConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: DurarConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: DurarConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: DurarConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: DurarConfig }): Promise<void> {
