...
export function isAcpEnabledByPolicy(cfg: DurarConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: DurarConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: DurarConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: DurarConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: DurarConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: DurarConfig, agentId: string): boolean {
