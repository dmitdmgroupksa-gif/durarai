...
import type { DurarConfig } from "./config-runtime.js";
...
type ApproverRestrictedNativeApprovalParams = {
  ...
  isNativeDeliveryEnabled: (params: { cfg: DurarConfig; accountId?: string | null }) => boolean;
...
function buildApproverRestrictedNativeApprovalCapability(
  ...
  return createChannelApprovalCapability({
    ...
    approvals: {
      delivery: {
        hasConfiguredDmRoute: ({ cfg }: { cfg: DurarConfig }) =>
