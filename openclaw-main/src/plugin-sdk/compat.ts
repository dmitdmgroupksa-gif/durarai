...
const shouldWarnCompatImport =
  ...
  process.env.Durar_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "Durar/plugin-sdk/compat is deprecated for new plugins. Migrate to focused Durar/plugin-sdk/<subpath> imports. See https://docs.Durar.ai/plugins/sdk-migration",
    {
      code: "Durar_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.Durar.ai/plugins/sdk-migration",
    },
  );
}
