...
import type { DurarPluginApi, DurarPluginConfigSchema } from "../plugins/types.js";
...
export type { DurarPluginToolContext, DurarPluginToolFactory } from "../plugins/types.js";
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerCliMetadata?: (api: DurarPluginApi) => void;
  registerFull?: (api: DurarPluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: DurarConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
