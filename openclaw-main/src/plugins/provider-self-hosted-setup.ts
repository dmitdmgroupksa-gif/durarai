...
export function applyProviderDefaultModel(cfg: DurarConfig, modelRef: string): DurarConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: DurarConfig; modelId: string; modelRef: string; profileId: string } {
