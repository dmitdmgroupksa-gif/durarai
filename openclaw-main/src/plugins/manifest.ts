...
export const PLUGIN_MANIFEST_FILENAME = "Durar.plugin.json";
...
// package.json "Durar" metadata (used for setup/catalog)
...
export type DurarPackageStartup = {
  /**
...
export type DurarPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: DurarPackageStartup;
};
...
): DurarPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
