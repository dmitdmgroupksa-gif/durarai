...
import type { DurarPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = DurarPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("Durar.pluginCommandsState");
