...
export function applyGoogleGeminiModelDefault(cfg: DurarConfig): {
  next: DurarConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: DurarConfig): DurarConfig {
...
export function applyOpenAIConfig(cfg: DurarConfig): DurarConfig {
...
export function applyOpencodeGoModelDefault(cfg: DurarConfig): {
  next: DurarConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: DurarConfig): {
  next: DurarConfig;
  changed: boolean;
} {
