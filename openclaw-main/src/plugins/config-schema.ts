...
import type { PluginConfigUiHint, DurarPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: DurarPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): DurarPluginConfigSchema {
  return {
