...
describe("runCommandWithTimeout", () => {
  ...
  it("merges custom env with base env and drops undefined values", async () => {
    ...
    expect(resolved.Durar_BASE_ENV).toBe("base");
    expect(resolved.Durar_TEST_ENV).toBe("ok");
    expect(resolved.Durar_TO_REMOVE).toBeUndefined();
    expect(resolved.Durar_CLI).toBe(Durar_CLI_ENV_VALUE);
  });
