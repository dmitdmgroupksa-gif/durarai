...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.Durar_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.Durar_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.Durar_SERVICE_MARKER = originalServiceMarker;
    }
  });
