...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set Durar_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `Durar dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Durar.");
  } else if (hint) {
    runtime.log(hint);
  }
}
