...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.Durar.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("Durar hooks list")}`,
      `  ${formatCliCommand("Durar hooks enable <name>")}`,
      `  ${formatCliCommand("Durar hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
