...
function noteFlowRecoveryHints() {
  ...
  note(
    [
      ...
      `Inspect: ${formatCliCommand("Durar tasks flow show <flow-id>")}`,
      `Cancel: ${formatCliCommand("Durar tasks flow cancel <flow-id>")}`,
    ]
...
export function noteWorkspaceStatus(cfg: DurarConfig) {
