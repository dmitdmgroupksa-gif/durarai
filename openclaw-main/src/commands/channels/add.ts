...
import { replaceConfigFile, type DurarConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: DurarConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as DurarConfig;
  ...
  // May trigger loadDurarPlugins on cache miss (disk scan + jiti import)
