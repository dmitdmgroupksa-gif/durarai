...
export function listChannelMessageActions(cfg: DurarConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: DurarConfig): ChannelMessageCapability[] {
