...
export const A2UI_PATH = "/__Durar__/a2ui";

export const CANVAS_HOST_PATH = "/__Durar__/canvas";

export const CANVAS_WS_PATH = "/__Durar__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.DurarCanvasA2UIAction.postMessage(...)
  // - Android: window.DurarCanvasA2UIAction.postMessage(...)
  const handlerNames = ["DurarCanvasA2UIAction"];
  ...
  globalThis.Durar = globalThis.Durar ?? {};
  globalThis.Durar.postMessage = postToNode;
  globalThis.Durar.sendUserAction = sendUserAction;
  globalThis.DurarPostMessage = postToNode;
  globalThis.DurarSendUserAction = sendUserAction;
