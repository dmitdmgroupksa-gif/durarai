...
function resolveAnthropicDefaultAuthMode(cfg: DurarConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: DurarConfig): DurarConfig {
...
export function applyTalkApiKey(config: DurarConfig): DurarConfig {
...
export function applyTalkConfigNormalization(config: DurarConfig): DurarConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: DurarConfig): DurarConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: DurarConfig): DurarConfig {
...
export function applyLoggingDefaults(cfg: DurarConfig): DurarConfig {
...
export function applyContextPruningDefaults(cfg: DurarConfig): DurarConfig {
...
export function applyCompactionDefaults(cfg: DurarConfig): DurarConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
