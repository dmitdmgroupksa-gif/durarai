...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): DurarConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: DurarConfig, env: NodeJS.ProcessEnv) =>
