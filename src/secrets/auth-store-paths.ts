...
export function listAuthProfileStorePaths(config: DurarConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: DurarConfig, stateDir: string): string[] {
