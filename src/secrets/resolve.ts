...
function resolveResolutionLimits(config: DurarConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: DurarConfig): SecretProviderConfig {
