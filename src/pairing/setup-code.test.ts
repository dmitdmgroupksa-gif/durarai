...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("Durar_GATEWAY_TOKEN", "");
    vi.stubEnv("Durar_GATEWAY_PASSWORD", "");
    vi.stubEnv("Durar_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses Durar_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
