...
import type {
  ...
  DurarPluginApi,
  DurarPluginChannelRegistration,
  DurarPluginCliCommandDescriptor,
  DurarPluginCliRegistrar,
  DurarPluginCommandDefinition,
  PluginConversationBindingResolvedEvent,
  DurarPluginHttpRouteAuth,
  DurarPluginHttpRouteMatch,
  DurarPluginHttpRouteHandler,
  DurarPluginHttpRouteParams,
  DurarPluginHookOptions,
...
export type PluginToolRegistration = {
  pluginId: string;
  pluginName?: string;
  factory: DurarPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
  rootDir?: string;
...
export type PluginCliRegistration = {
  pluginId: string;
  pluginName?: string;
  register: DurarPluginCliRegistrar;
  commands: string[];
...
export type PluginCommandRegistration = {
  pluginId: string;
  pluginName?: string;
  command: DurarPluginCommandDefinition;
  source: string;
  rootDir?: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: DurarPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: DurarPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: DurarPluginHookOptions | undefined,
    config: DurarPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: DurarPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: DurarPluginChannelRegistration | ChannelPlugin,
    mode: PluginRegistrationMode = "full",
  ) => {
    const normalized =
      typeof (registration as DurarPluginChannelRegistration).plugin === "object"
        ? (registration as DurarPluginChannelRegistration)
  ...
  const registerCli = (
    ...
    opts?: { commands?: string[]; descriptors?: DurarPluginCliCommandDescriptor[] },
  ) => {
  ...
  const registerService = (record: PluginRecord, service: DurarPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: DurarPluginCommandDefinition) => {
