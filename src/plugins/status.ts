...
import { normalizeDurarVersionBase } from "../config/version.js";
...
import { loadDurarPlugins } from "./loader.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeDurarVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeDurarVersionBase(plugin.version) ??
    plugin.version
  );
}
