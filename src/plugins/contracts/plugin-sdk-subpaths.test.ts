...
} from "Durar/plugin-sdk/channel-contract";
import type {
  ChannelMessageActionContext as CoreChannelMessageActionContext,
  DurarPluginApi as CoreDurarPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "Durar/plugin-sdk/core";
import * as providerEntrySdk from "Durar/plugin-sdk/provider-entry";
...
import type {
  ...
  DurarPluginApi as SharedDurarPluginApi,
...
import type { DurarPluginApi } from "../types.js";
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreDurarPluginApi>().toMatchTypeOf<DurarPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreDurarPluginApi>().toMatchTypeOf<SharedDurarPluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("Durar/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("Durar/plugin-sdk/channel-actions"),
      importResolvedPluginSdkSubpath("Durar/plugin-sdk/global-singleton"),
      importResolvedPluginSdkSubpath("Durar/plugin-sdk/text-runtime"),
      importResolvedPluginSdkSubpath("Durar/plugin-sdk/huggingface"),
      importResolvedPluginSdkSubpath("Durar/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("Durar/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("Durar/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("Durar/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`Durar/plugin-sdk/${id}`),
      ),
    ]);
