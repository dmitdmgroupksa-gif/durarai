...
export const DEFAULT_Durar_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export const DEFAULT_Durar_BROWSER_COLOR = "#FF4500";
export const DEFAULT_Durar_BROWSER_PROFILE_NAME = "Durar";
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "Durar";
...
function normalizeHexColor(raw: string | undefined) {
  ...
  if (!value) {
    return DEFAULT_Durar_BROWSER_COLOR;
  }
...
function ensureDefaultProfile(
  ...
  if (!result[DEFAULT_Durar_BROWSER_PROFILE_NAME]) {
    result[DEFAULT_Durar_BROWSER_PROFILE_NAME] = {
...
export function resolveBrowserConfig(
  ...
  rootConfig?: DurarConfig,
): ResolvedBrowserConfig {
  const enabled = cfg?.enabled ?? DEFAULT_Durar_BROWSER_ENABLED;
  ...
  const defaultProfile =
    ...
    (profiles[DEFAULT_BROWSER_DEFAULT_PROFILE_NAME]
      ...
      : profiles[DEFAULT_Durar_BROWSER_PROFILE_NAME]
...
export function resolveProfile(
  ...
  let cdpUrl = "";
  const driver = profile.driver === "existing-session" ? "existing-session" : "Durar";
