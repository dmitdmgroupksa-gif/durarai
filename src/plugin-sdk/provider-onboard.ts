...
export type { DurarConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: DurarConfig, ...args: TArgs) => DurarConfig;
  applyConfig: (cfg: DurarConfig, ...args: TArgs) => DurarConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: DurarConfig, preset: TParams) => DurarConfig;
  primaryModelRef: string;
