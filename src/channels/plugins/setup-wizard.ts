...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: DurarConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: DurarConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: DurarConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: DurarConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: DurarConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: DurarConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: DurarConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: DurarConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: DurarConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: DurarConfig) => DurarConfig;
