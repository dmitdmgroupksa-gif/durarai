...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: DurarConfig): string | undefined {
  ...
  function listAccountIds(cfg: DurarConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: DurarConfig): string {
