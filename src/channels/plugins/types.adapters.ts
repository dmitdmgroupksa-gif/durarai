...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: DurarConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: DurarConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: DurarConfig) => string;
  setAccountEnabled?: (params: {
    cfg: DurarConfig;
    accountId: string;
    enabled: boolean;
  }) => DurarConfig;
  deleteAccount?: (params: { cfg: DurarConfig; accountId: string }) => DurarConfig;
  isEnabled?: (account: ResolvedAccount, cfg: DurarConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: DurarConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: DurarConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: DurarConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: DurarConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.Durar.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: DurarConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: DurarConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: DurarConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: DurarConfig; accountId?: string | null }) =>
    | {
