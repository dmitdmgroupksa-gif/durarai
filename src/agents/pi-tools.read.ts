...
function resolveAdaptiveReadMaxBytes(options?: DurarReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createDurarReadTool(base, {
...
export function createDurarReadTool(
  base: AnyAgentTool,
  options?: DurarReadToolOptions,
): AnyAgentTool {
