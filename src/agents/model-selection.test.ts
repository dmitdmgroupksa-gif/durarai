...
function resolveAnthropicOpusThinking(cfg: DurarConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<DurarConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<DurarConfig>) {
