...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.Durar/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "Durar doctor" and "Durar approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
