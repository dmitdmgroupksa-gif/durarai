...
async function resolveContext(config: DurarConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): DurarConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
