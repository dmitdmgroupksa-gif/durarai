...
export const createDurarCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createDurarCodingToolsMock.mockReset();
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureDurarModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveDurarDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createDurarCodingTools: createDurarCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveDurarAgentDir: vi.fn(() => "/tmp"),
  }));
