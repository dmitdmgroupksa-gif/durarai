...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<DurarConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<DurarConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: DurarConfig): WebSearchConfig {
