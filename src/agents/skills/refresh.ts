...
function resolveWatchPaths(workspaceDir: string, config?: DurarConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: DurarConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: DurarConfig }) {
