...
export function isCliProvider(provider: string, cfg?: DurarConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: DurarConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: DurarConfig }): ModelCatalogEntry[] {
