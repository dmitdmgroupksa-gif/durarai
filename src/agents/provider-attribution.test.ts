...
describe("provider attribution", () => {
  it("resolves the canonical Durar product and runtime version", () => {
  ...
  it("returns a documented OpenRouter attribution policy", () => {
    ...
    expect(policy).toEqual({
      ...
      reviewNote: "Documented app attribution headers. Verified in Durar runtime wrapper.",
      product: "Durar",
      version: "2026.3.22",
      headers: {
        "HTTP-Referer": "https://Durar.ai",
        "X-OpenRouter-Title": "Durar",
  ...
  it("returns a hidden-spec OpenAI attribution policy", () => {
    expect(resolveProviderAttributionPolicy("openai", { Durar_VERSION: "2026.3.22" })).toEqual({
      provider: "openai",
      enabledByDefault: true,
      ...
      headers: {
        originator: "Durar",
        version: "2026.3.22",
        "User-Agent": "Durar/2026.3.22",
      },
    });
    expect(resolveProviderAttributionHeaders("openai", { Durar_VERSION: "2026.3.22" })).toEqual({
      originator: "Durar",
      version: "2026.3.22",
      "User-Agent": "Durar/2026.3.22",
    });
  ...
  it("returns a hidden-spec OpenAI Codex attribution policy", () => {
    expect(
      resolveProviderAttributionPolicy("openai-codex", { Durar_VERSION: "2026.3.22" }),
    ).toEqual({
  ...
  it("lists the current attribution support matrix", () => {
    expect(
      listProviderAttributionPolicies({ Durar_VERSION: "2026.3.22" }).map((policy) => [
        policy.provider,
