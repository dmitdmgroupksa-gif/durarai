...
const defaultDurarToolsDeps: DurarToolsDeps = {
  callGateway,
};

let DurarToolsDeps: DurarToolsDeps = defaultDurarToolsDeps;

export function createDurarTools(
  options?: {
  ...
  const resolvedConfig = options?.config ?? DurarToolsDeps.config;
  ...
  const tools: AnyAgentTool[] = [
    ...
    createSessionsListTool({
      ...
      sandboxed: options?.sandboxed,
      config: resolvedConfig,
      callGateway: DurarToolsDeps.callGateway,
    }),
...
export const __testing = {
  setDepsForTest(overrides?: Partial<DurarToolsDeps>) {
    DurarToolsDeps = overrides
      ? {
          ...defaultDurarToolsDeps,
          ...overrides,
        }
      : defaultDurarToolsDeps;
  },
