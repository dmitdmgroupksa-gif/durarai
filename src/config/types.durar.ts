...
export type DurarConfig = {
  meta?: {
    /** Last Durar version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Durar UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const DurarConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = DurarConfig & {
  readonly [DurarConfigStateBrand]?: TState;
};
