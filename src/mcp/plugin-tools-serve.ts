/**
 * Standalone MCP server that exposes Durar plugin-registered tools
...
function resolveTools(config: DurarConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  const server = new Server(
    { name: "Durar-plugin-tools", version: VERSION },
    { capabilities: { tools: {} } },
  );
