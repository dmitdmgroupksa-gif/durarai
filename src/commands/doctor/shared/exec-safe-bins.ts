...
function collectExecSafeBinScopes(cfg: DurarConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: DurarConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: DurarConfig): {
  config: DurarConfig;
  changes: string[];
  warnings: string[];
} {
