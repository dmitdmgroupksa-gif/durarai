...
function resolveDefaultAccountId(cfg: DurarConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: DurarConfig): boolean {
...
export function summarizeBindings(cfg: DurarConfig, bindings: AgentBinding[]): string[] {
