import type { DurarConfig, HookConfig } from "../config/config.js";
...
const HOOK_SOURCE_POLICIES: Record<HookSource, HookSourcePolicy> = {
  "Durar-bundled": {
    ...
    canOverride: ["Durar-bundled"],
    canBeOverriddenBy: ["Durar-managed", "Durar-plugin"],
  },
  "Durar-plugin": {
    precedence: 20,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["Durar-bundled", "Durar-plugin"],
    canBeOverriddenBy: ["Durar-managed"],
  },
  "Durar-managed": {
    precedence: 30,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["Durar-bundled", "Durar-managed", "Durar-plugin"],
    canBeOverriddenBy: ["Durar-managed"],
  },
  "Durar-workspace": {
    precedence: 40,
    ...
    canOverride: ["Durar-workspace"],
    canBeOverriddenBy: ["Durar-workspace"],
  },
};
...
export function resolveHookEnableState(params: {
  ...
  if (entry.hook.source === "Durar-plugin") {
    return { enabled: true };
  }
