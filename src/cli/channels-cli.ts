    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["Durar channels list", "List configured channels and auth profiles."],
          ["Durar channels status --probe", "Run channel status checks and probes."],
          [
            "Durar channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["Durar channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.Durar.ai/cli/channels",
        )}\n`,
    );
