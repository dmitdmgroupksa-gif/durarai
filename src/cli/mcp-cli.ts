...
import { serveDurarChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage Durar MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose Durar channels over MCP stdio")
