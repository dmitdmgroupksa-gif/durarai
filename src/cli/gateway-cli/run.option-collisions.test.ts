...
vi.mock("../../config/config.js", () => ({
  getConfigPath: () => "/tmp/Durar-test-missing-config.json",
...
describe("gateway run option collisions", () => {
  ...
  it.each([
    ...
    delete process.env.Durar_CLI_BACKEND_LOG_OUTPUT;
    ...
    expect(process.env.Durar_CLI_BACKEND_LOG_OUTPUT).toBe("1");
  });
