      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["Durar gateway run", "Run the gateway in the foreground."],
            ["Durar gateway status", "Show service status and probe reachability."],
            ["Durar gateway discover", "Find local and wide-area gateway beacons."],
            ["Durar gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.Durar.ai/cli/gateway")}\n`,
      ),
  );
