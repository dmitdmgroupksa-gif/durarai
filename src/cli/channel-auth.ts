...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: DurarConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: DurarConfig, mode: ChannelAuthMode): string {
