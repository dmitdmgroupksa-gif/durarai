...
export function isCommandEnabled(cfg: DurarConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: DurarConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: DurarConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: DurarConfig) {
