...
function resolveAcpStreamCoalesceIdleMs(cfg: DurarConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: DurarConfig): number {
...
export function resolveAcpProjectionSettings(cfg: DurarConfig): AcpProjectionSettings {
