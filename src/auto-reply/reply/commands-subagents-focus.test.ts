...
function createMatrixThreadCommandParams(commandBody: string, cfg: DurarConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: DurarConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",
