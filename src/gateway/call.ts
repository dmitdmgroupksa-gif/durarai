...
function loadGatewayConfig(): DurarConfig {
  const loadConfigFn =
...
function resolveGatewayPortValue(config?: DurarConfig, env?: NodeJS.ProcessEnv): number {
...
function gatewaySecretInputPathCanWin(params: {
  ...
  const sentinel = `__Durar_GATEWAY_SECRET_REF_PROBE_${params.path.replaceAll(".", "_")}__`;
