...
function printUsage(): void {
  console.log(`Durar CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: Durar.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "Durar-cli-bench-"));
