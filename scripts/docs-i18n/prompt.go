...
- Keep product names in English: Durar, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Durar Gateway, use “Gateway 网关”.
