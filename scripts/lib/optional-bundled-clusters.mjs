...
export const OPTIONAL_BUNDLED_BUILD_ENV = "Durar_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.Durar?.install?.npmSpec === "string" &&
    packageJson.Durar.install.npmSpec.trim().length > 0
  );
}
