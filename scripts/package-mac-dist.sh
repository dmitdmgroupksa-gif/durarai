...
# Output:
# - dist/Durar.app
# - dist/Durar-<version>.zip
# - dist/Durar-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.Durar.mac}"
...
ZIP="$ROOT_DIR/dist/Durar-$VERSION.zip"
DMG="$ROOT_DIR/dist/Durar-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Durar-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Durar-$VERSION.dSYM.zip"
