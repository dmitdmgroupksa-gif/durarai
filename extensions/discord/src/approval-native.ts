...
import type { DiscordExecApprovalConfig, DurarConfig } from "Durar/plugin-sdk/config-runtime";
import type { ExecApprovalRequest, PluginApprovalRequest } from "Durar/plugin-sdk/infra-runtime";
