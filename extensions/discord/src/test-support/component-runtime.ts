...
async function createConversationRuntimeMock(
  importOriginal: () => Promise<typeof import("Durar/plugin-sdk/conversation-runtime")>,
) {
...
vi.mock("Durar/plugin-sdk/security-runtime", (importOriginal) =>
  createAllowFromRuntimeMock(importOriginal),
);

vi.mock("Durar/plugin-sdk/conversation-runtime", createConversationRuntimeMock);
vi.mock("Durar/plugin-sdk/conversation-runtime.js", createConversationRuntimeMock);
