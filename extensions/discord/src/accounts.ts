...
import { normalizeAccountId } from "Durar/plugin-sdk/account-id";
import { resolveAccountEntry } from "Durar/plugin-sdk/routing";
import type { DiscordAccountConfig, DiscordActionConfig, DurarConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: DurarConfig): ResolvedDiscordAccount[] {
