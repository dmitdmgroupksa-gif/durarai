...
} from "Durar/plugin-sdk/command-auth-native";
import {
...
} from "Durar/plugin-sdk/native-command-registry";
import type { DurarConfig, loadConfig } from "Durar/plugin-sdk/config-runtime";
...
import { buildPairingReply } from "Durar/plugin-sdk/conversation-runtime";
import { getAgentScopedMediaLocalRoots } from "Durar/plugin-sdk/media-runtime";
import * as pluginRuntime from "Durar/plugin-sdk/plugin-runtime";
import {
  resolveSendableOutboundReplyParts,
  resolveTextChunksWithFallback,
} from "Durar/plugin-sdk/reply-payload";
import * as replyRuntime from "Durar/plugin-sdk/reply-runtime";
...
type DiscordConfig = NonNullable<DurarConfig["channels"]>["discord"];
