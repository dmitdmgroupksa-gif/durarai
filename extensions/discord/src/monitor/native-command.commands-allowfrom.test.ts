...
import * as pluginCommandsModule from "Durar/plugin-sdk/plugin-runtime";
...
function createCommand(cfg: DurarConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: DurarConfig) => void;
