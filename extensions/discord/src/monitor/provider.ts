...
import type { DurarConfig, ReplyToMode } from "Durar/plugin-sdk/config-runtime";
...
} from "Durar/plugin-sdk/runtime-group-policy";
...
import { summarizeStringEntries } from "Durar/plugin-sdk/text-runtime";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("Durar/plugin-sdk/reply-history").HistoryEntry[]
    >();
