...
type LoadedConfig = ReturnType<typeof import("Durar/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("Durar/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("Durar/plugin-sdk/runtime-env").createSubsystemLogger>;
