...
import { resolveHumanDelayConfig } from "Durar/plugin-sdk/agent-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "Durar/plugin-sdk/channel-inbound";
import { enqueueSystemEvent } from "Durar/plugin-sdk/channel-runtime";
import type { DurarConfig } from "Durar/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "Durar/plugin-sdk/dangerous-name-runtime";
import { resolveMarkdownTableMode } from "Durar/plugin-sdk/markdown-table-runtime";
import { resolveOpenProviderRuntimeGroupPolicy } from "Durar/plugin-sdk/runtime-group-policy";
import { readSessionUpdatedAt, resolveStorePath } from "Durar/plugin-sdk/session-store-runtime";
import type { DiscordAccountConfig } from "Durar/plugin-sdk/config-runtime";
import { getAgentScopedMediaLocalRoots } from "Durar/plugin-sdk/media-runtime";
import {
  type PluginInteractiveDiscordHandlerContext,
} from "Durar/plugin-sdk/plugin-runtime";
import { logVerbose } from "Durar/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "Durar/plugin-sdk/runtime-env";
import { logDebug, logError } from "Durar/plugin-sdk/text-runtime";
import {
...
let conversationRuntimePromise:
  | Promise<typeof import("Durar/plugin-sdk/conversation-runtime")>
  | undefined;
let componentsRuntimePromise: Promise<typeof import("../components.js")> | undefined;
let pluginRuntimePromise: Promise<typeof import("Durar/plugin-sdk/plugin-runtime")> | undefined;
let replyRuntimePromise: Promise<typeof import("Durar/plugin-sdk/reply-runtime")> | undefined;
let replyPipelineRuntimePromise:
  | Promise<typeof import("Durar/plugin-sdk/channel-reply-pipeline")>
  | undefined;
...
async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("Durar/plugin-sdk/conversation-runtime");
...
async function loadPluginRuntime() {
  pluginRuntimePromise ??= import("Durar/plugin-sdk/plugin-runtime");
  return await pluginRuntimePromise;
}

async function loadReplyRuntime() {
  replyRuntimePromise ??= import("Durar/plugin-sdk/reply-runtime");
  return await replyRuntimePromise;
}

async function loadReplyPipelineRuntime() {
  replyPipelineRuntimePromise ??= import("Durar/plugin-sdk/channel-reply-pipeline");
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__Durar_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__Durar_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__Durar_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__Durar_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__Durar_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__Durar_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "Durar form";
  customId = "__Durar_discord_component_modal_wildcard__";
  components = [];
