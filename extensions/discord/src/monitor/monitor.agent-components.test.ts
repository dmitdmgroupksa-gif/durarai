...
import { peekSystemEvents, resetSystemEventsForTest } from "Durar/plugin-sdk/testing";
...
describe("agent components", () => {
  ...
  const createCfg = (): DurarConfig => ({}) as DurarConfig;
  ...
  it("sends pairing reply when DM sender is not allowlisted", async () => {
    ...
    expect(pairingText).toContain(`Durar pairing approve discord ${code}`);
