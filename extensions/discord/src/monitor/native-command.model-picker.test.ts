...
import * as commandRegistryModule from "Durar/plugin-sdk/command-auth";
import type { ChatCommandDefinition, CommandArgsParsing } from "Durar/plugin-sdk/command-auth";
import type { ModelsProviderData } from "Durar/plugin-sdk/command-auth";
import type { DurarConfig } from "Durar/plugin-sdk/config-runtime";
import * as dispatcherModule from "Durar/plugin-sdk/reply-runtime";
import * as globalsModule from "Durar/plugin-sdk/runtime-env";
import * as commandTextModule from "Durar/plugin-sdk/text-runtime";
...
function createDispatchSpy() {
  ...
  nativeCommandTesting.setDispatchReplyWithDispatcher(
    dispatcherModule.dispatchReplyWithDispatcher as typeof import("Durar/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
  );
  return dispatchSpy;
}
