...
import { parseDurationMs } from "Durar/plugin-sdk/cli-runtime";
import {
  definePluginEntry,
...
import { cloneFirstTemplateModel } from "Durar/plugin-sdk/provider-model-shared";
import { fetchClaudeUsage } from "Durar/plugin-sdk/provider-usage";
...
function buildAnthropicAuthDoctorHint(params: {
  ...
  return [
    ...
    `Fix: run "${formatCliCommand("Durar doctor --yes")}"`,
  ].join("\n");
}
