import type { ChannelSetupAdapter, DurarConfig } from "Durar/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "Durar/plugin-sdk/setup";
...
export function isLineConfigured(cfg: DurarConfig, accountId: string): boolean {
