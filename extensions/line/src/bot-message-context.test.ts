...
import { __testing as sessionBindingTesting } from "Durar/plugin-sdk/conversation-runtime";
...
type AgentBinding = NonNullable<DurarConfig["bindings"]>[number];
...
describe("buildLineMessageContext", () => {
  ...
  beforeEach(async () => {
    ...
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "Durar-line-context-"));
