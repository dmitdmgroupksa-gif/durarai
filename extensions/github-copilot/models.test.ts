...
vi.mock("Durar/plugin-sdk/provider-model-shared", () => ({
...
vi.mock("Durar/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("Durar/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/Durar-state",
}));

import type { ProviderResolveDynamicModelContext } from "Durar/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/Durar-state/credentials/github-copilot.token.json";
