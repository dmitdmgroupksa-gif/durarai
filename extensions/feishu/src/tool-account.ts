...
import type { DurarPluginApi } from "../runtime-api.js";
import {
...
function readConfiguredDefaultAccountId(config: DurarPluginApi["config"]): string | undefined {
...
function resolveImplicitToolAccountId(params: {
  api: Pick<DurarPluginApi, "config">;
