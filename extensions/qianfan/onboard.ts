...
function resolveQianfanPreset(cfg: DurarConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: DurarConfig): DurarConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: DurarConfig): DurarConfig {
