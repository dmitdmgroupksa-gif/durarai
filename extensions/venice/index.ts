...
import { applyModelCompatPatch } from "Durar/plugin-sdk/provider-model-shared";
import type { ModelCompatConfig } from "Durar/plugin-sdk/provider-model-shared";
import { XAI_UNSUPPORTED_SCHEMA_KEYWORDS } from "Durar/plugin-sdk/provider-tools";
