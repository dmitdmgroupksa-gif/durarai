...
This package contains the **BlueBubbles external channel plugin** for Durar.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `Durar/plugin-sdk` helpers.
