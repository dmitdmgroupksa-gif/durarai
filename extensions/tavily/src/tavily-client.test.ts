...
vi.mock("Durar/plugin-sdk/provider-web-search", () => ({
...
vi.mock("Durar/plugin-sdk/security-runtime", () => ({
...
describe("tavily client X-Client-Source header", () => {
  ...
  it("runTavilySearch sends X-Client-Source: Durar", async () => {
    ...
    expect(params.extraHeaders).toEqual({ "X-Client-Source": "Durar" });
  });

  it("runTavilyExtract sends X-Client-Source: Durar", async () => {
