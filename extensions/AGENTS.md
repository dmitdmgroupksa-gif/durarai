...
- Extension production code should import from `Durar/plugin-sdk/*` and its
...
- Keep plugin metadata accurate in `Durar.plugin.json` and the package
  `Durar` block so discovery and setup work without executing plugin code.
