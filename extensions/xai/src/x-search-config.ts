...
export function resolveLegacyXSearchConfig(config?: DurarConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: DurarConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: DurarConfig): JsonRecord | undefined {
