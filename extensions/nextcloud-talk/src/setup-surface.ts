import type { ChannelSetupInput } from "Durar/plugin-sdk/channel-setup";
import type { DurarConfig } from "Durar/plugin-sdk/config-runtime";
import { DEFAULT_ACCOUNT_ID } from "Durar/plugin-sdk/routing";
import { hasConfiguredSecretInput } from "Durar/plugin-sdk/secret-input";
import {
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "Durar" "<shared-secret>" "<webhook-url>" --feature reaction',
