import { createActionGate } from "Durar/plugin-sdk/agent-runtime";
import type { ChannelMessageActionName } from "Durar/plugin-sdk/channel-contract";
import type { DurarConfig } from "Durar/plugin-sdk/config-runtime";
import type { ChannelToolSend } from "Durar/plugin-sdk/tool-send";
import { listEnabledSlackAccounts } from "./accounts.js";

export function listSlackMessageActions(cfg: DurarConfig): ChannelMessageActionName[] {
