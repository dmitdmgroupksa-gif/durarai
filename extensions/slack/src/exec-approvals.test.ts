...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<DurarConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<DurarConfig["channels"]>["slack"]>>,
): DurarConfig {
  return {
    channels: {
      slack: {
