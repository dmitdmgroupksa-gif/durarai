...
import { createChannelPluginBase } from "Durar/plugin-sdk/core";
import {
  formatDocsLink,
...
import { getChatChannelMeta, type ChannelPlugin, type DurarConfig } from "./runtime-api.js";

export const SLACK_CHANNEL = "slack" as const;

function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "Durar";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Durar`,
    },
    features: {
      bot_user: {
...
export function buildSlackSetupLines(botName = "Durar"): string[] {
  return [
