...
import { createAccountStatusSink } from "Durar/plugin-sdk/channel-lifecycle";
import { createPairingPrefixStripper } from "Durar/plugin-sdk/channel-pairing";
import {
  createEmptyChannelResult,
  createRawChannelSendResultAdapter,
} from "Durar/plugin-sdk/channel-send-result";
import { createStaticReplyToModeResolver } from "Durar/plugin-sdk/conversation-runtime";
...
function resolveZalouserOutboundChunkMode(cfg: DurarConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: DurarConfig, accountId?: string) {
