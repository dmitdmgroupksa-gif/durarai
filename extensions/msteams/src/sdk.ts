 ...
 * middleware with the pattern `/api*`.  When the host application (Durar)
 * uses Express 5 — which depends on path-to-regexp v8 — that pattern is
 * invalid and throws:
 *
 *   Missing parameter name at index 5: /api*
 *
 * Durar manages its own Express server for the Teams webhook endpoint, so
 ...
 *
 * See: https://github.com/dmitdmgroupksa-gif/durarai/issues/55161
 */
