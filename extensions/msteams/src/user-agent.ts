...
function resolveDurarVersion(): string {
  try {
 ...
 * and appends the Durar version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Durar/<Durar-version>"
 * Example: "teams.ts[apps]/2.0.5 Durar/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Durar/${resolveDurarVersion()}`;
  return cachedUserAgent;
}
