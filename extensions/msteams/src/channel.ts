import { describeAccountSnapshot } from "Durar/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "Durar/plugin-sdk/allow-from";
import { createMessageToolCardSchema } from "Durar/plugin-sdk/channel-actions";
import { createTopLevelChannelConfigAdapter } from "Durar/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "Durar/plugin-sdk/channel-contract";
import { createPairingPrefixStripper } from "Durar/plugin-sdk/channel-pairing";
import {
  createAllowlistProviderGroupPolicyWarningCollector,
  projectConfigWarningCollector,
} from "Durar/plugin-sdk/channel-policy";
import { createChatChannelPlugin } from "Durar/plugin-sdk/core";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
  listDirectoryEntriesFromSources,
} from "Durar/plugin-sdk/directory-runtime";
import { createLazyRuntimeNamedExport } from "Durar/plugin-sdk/lazy-runtime";
import { createRuntimeOutboundDelegates } from "Durar/plugin-sdk/outbound-runtime";
import { createComputedAccountStatusAdapter } from "Durar/plugin-sdk/status-helpers";
import type { ChannelMessageActionName, ChannelPlugin, DurarConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: DurarConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: DurarConfig }>(
