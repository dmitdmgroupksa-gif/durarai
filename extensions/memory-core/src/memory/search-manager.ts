...
import { checkQmdBinaryAvailability } from "Durar/plugin-sdk/memory-core-host-engine-qmd";
import {
...
const MEMORY_SEARCH_MANAGER_CACHE_KEY = Symbol.for("Durar.memorySearchManagerCache");
