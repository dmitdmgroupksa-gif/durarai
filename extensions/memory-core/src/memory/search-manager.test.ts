...
import type { checkQmdBinaryAvailability as checkQmdBinaryAvailabilityFn } from "Durar/plugin-sdk/memory-core-host-engine-qmd";
...
vi.mock("Durar/plugin-sdk/memory-core-host-engine-qmd", () => ({
...
function createQmdCfg(agentId: string): DurarConfig {
  return {
