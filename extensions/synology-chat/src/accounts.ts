...
import {
  ...
  type DurarConfig,
} from "Durar/plugin-sdk/account-resolution";
import { resolveDangerousNameMatchingEnabled } from "Durar/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full Durar config object. */
function getChannelConfig(cfg: DurarConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: DurarConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.Durar_BOT_NAME ?? "Durar";
