...
Read-only diff viewer plugin for **Durar** agents.
...
Before:
Durar supports plugins.

After:
Durar supports plugins and hosted diff views.
```
...
- Artifacts are ephemeral and stored in the plugin temp subfolder (`$TMPDIR/Durar-diffs`).
