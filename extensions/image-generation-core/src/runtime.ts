...
function buildNoImageGenerationModelConfiguredMessage(cfg: DurarConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: DurarConfig }) {
