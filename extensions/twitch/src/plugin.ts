/**
 * Twitch channel plugin for Durar.
 *
 ...
 * for Durar. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<ResolvedTwitchAccount> =
  createChatChannelPlugin<ResolvedTwitchAccount>({
    ...
    base: {
      ...
      config: {
        listAccountIds: (cfg: DurarConfig): string[] => listAccountIds(cfg),
        resolveAccount: (cfg: DurarConfig, accountId?: string | null): ResolvedTwitchAccount => {
        ...
        isConfigured: (_account: unknown, cfg: DurarConfig): boolean =>
