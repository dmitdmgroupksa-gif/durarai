...
function createCfg(): DurarConfig {
  return {
    channels: {
      telegram: {
        enabled: true,
...
function resolveAccount(cfg: DurarConfig, accountId: string): ResolvedTelegramAccount {
  return telegramPlugin.config.resolveAccount(cfg, accountId) as ResolvedTelegramAccount;
}

function createStartTelegramContext(cfg: DurarConfig, accountId: string) {
...
function startTelegramAccount(cfg: DurarConfig, accountId: string) {
...
function configureOpsProxyNetwork(cfg: DurarConfig) {
