...
} from "Durar/plugin-sdk/channel-actions";
...
import type { TelegramActionConfig } from "Durar/plugin-sdk/config-runtime";
import { extractToolSend } from "Durar/plugin-sdk/tool-send";
import {
