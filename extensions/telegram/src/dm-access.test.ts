import type { createChannelPairingChallengeIssuer } from "Durar/plugin-sdk/channel-pairing";
...
vi.mock("Durar/plugin-sdk/channel-pairing", () => ({
...
vi.mock("Durar/plugin-sdk/conversation-runtime", () => ({
