...
import { resolveAgentMaxConcurrent } from "Durar/plugin-sdk/config-runtime";
import type { DurarConfig } from "Durar/plugin-sdk/config-runtime";
import { loadConfig } from "Durar/plugin-sdk/config-runtime";
import { waitForAbortSignal } from "Durar/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: DurarConfig): RunOptions<unknown> {
  return {
    sink: {
