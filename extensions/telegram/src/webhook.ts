...
import { safeEqualSecret } from "Durar/plugin-sdk/browser-support";
import type { DurarConfig } from "Durar/plugin-sdk/config-runtime";
import { isDiagnosticsEnabled } from "Durar/plugin-sdk/diagnostic-runtime";
import type { RuntimeEnv } from "Durar/plugin-sdk/runtime-env";
import { defaultRuntime } from "Durar/plugin-sdk/runtime-env";
...
import { readJsonBodyWithLimit } from "Durar/plugin-sdk/webhook-request-guards";
...
function resolveTelegramWebhookClientIp(req: IncomingMessage, config?: DurarConfig): string {
