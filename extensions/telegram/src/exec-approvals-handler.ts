import { buildPluginApprovalPendingReplyPayload } from "Durar/plugin-sdk/approval-runtime";
import type { DurarConfig } from "Durar/plugin-sdk/config-runtime";
import {
  createChannelNativeApprovalRuntime,
  resolveExecApprovalRequestAllowedDecisions,
  type ExecApprovalChannelRuntime,
} from "Durar/plugin-sdk/infra-runtime";
import { resolveExecApprovalCommandDisplay } from "Durar/plugin-sdk/infra-runtime";
import {
...
function isHandlerConfigured(params: { cfg: DurarConfig; accountId: string }): boolean {
