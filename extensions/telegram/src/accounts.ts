...
import {
  ...
  type DurarConfig,
} from "Durar/plugin-sdk/account-core";
import {
  listBoundAccountIds,
  resolveDefaultAgentBoundAccountId,
} from "Durar/plugin-sdk/routing";
import { formatSetExplicitDefaultInstruction } from "Durar/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "Durar/plugin-sdk/runtime-env";
import type {
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.Durar_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: DurarConfig): string[] {
...
export function listTelegramAccountIds(cfg: DurarConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: DurarConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/dmitdmgroupksa-gif/durarai/issues/30673
...
export function listEnabledTelegramAccounts(cfg: DurarConfig): ResolvedTelegramAccount[] {
