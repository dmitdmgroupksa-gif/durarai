...
import type { ChannelGroupPolicy } from "Durar/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "Durar/plugin-sdk/config-runtime";
import type { RuntimeEnv } from "Durar/plugin-sdk/runtime-env";
...
type GetPluginCommandSpecsFn =
  typeof import("Durar/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("Durar/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("Durar/plugin-sdk/plugin-runtime").executePluginCommand;
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("Durar/plugin-sdk/reply-dispatch-runtime").dispatchReplyWithBufferedBlockDispatcher;
type DispatchReplyWithBufferedBlockDispatcherResult = Awaited<
  ReturnType<DispatchReplyWithBufferedBlockDispatcherFn>
>;
type RecordInboundSessionMetaSafeFn =
  typeof import("Durar/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
...
vi.mock("Durar/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("Durar/plugin-sdk/reply-dispatch-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("Durar/plugin-sdk/reply-dispatch-runtime")>();
  return {
    ...actual,
...
vi.mock("Durar/plugin-sdk/conversation-runtime", async (importOriginal) => {
...
vi.mock("Durar/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("Durar/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as DurarConfig)),
