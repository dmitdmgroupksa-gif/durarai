import { createAccountListHelpers } from "Durar/plugin-sdk/account-helpers";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "Durar/plugin-sdk/account-id";
import { resolveMergedAccountConfig } from "Durar/plugin-sdk/account-resolution";
...
export function listMattermostAccountIds(cfg: DurarConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: DurarConfig): string {
...
export function listEnabledMattermostAccounts(cfg: DurarConfig): ResolvedMattermostAccount[] {
