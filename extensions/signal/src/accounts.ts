...
function mergeSignalAccountConfig(cfg: DurarConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: DurarConfig): ResolvedSignalAccount[] {
