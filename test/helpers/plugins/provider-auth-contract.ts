...
type LoginOpenAICodexOAuth =
  (typeof import("Durar/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("Durar/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("Durar/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("Durar/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("Durar/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("Durar/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("Durar/plugin-sdk/provider-auth", async (importOriginal) => {
  const actual = await importOriginal<typeof import("Durar/plugin-sdk/provider-auth")>();
  return {
    ...actual,
